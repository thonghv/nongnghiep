...
<div class="row-fluid">
    <h3 class="header smaller lighter blue">Bình Luận
        ...
        <table id="table_report" class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th style ="width: 90px;">Bình Chọn</th>
                    <th></th>
                </tr>
            </thead>                   
            <tbody>
                ...
                <tr>
                    ...
                    <td id="masp">
                        <a target="_blank" href='<?php echo base_url(); ?>question/slug-question-<?php echo $row -> ques_id; ?>.html'>
                            <?php 
                                $limit = 100;
                                $desc = $row -> content;
                    ...
                    <td><?php echo date("d/m/Y", strtotime($row -> ans_date));?></td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Bạn có chắc chắn muốn xóa bình luận này vĩnh viễn không ?</p>
                                            <p class="debug-url"></p>
                                        </div>
                                        
                                        <div class="modal-footer">
                                            <a  href="<?php echo base_url(); ?>wp-admin/answers/onRemove/<?php echo $row->id; ?>" class="btn btn-danger btn-ok">Xóa</a>

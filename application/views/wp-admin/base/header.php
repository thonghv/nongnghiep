		  ...
		  <div class="navbar-inner">
		   <div class="container-fluid">
			   <div class="navbar-header pull-left" style ="margin-top: 5px;">
            		<a href="<?php echo base_url()?>wp-admin" class="navbar-brand"><small><img src="<?php echo base_url()?>public/img/logo.png"/></small></a>        
				</div><!-- /.navbar-header -->
			  <ul class="nav ace-nav pull-right">
					...
					<li class="light-blue user-profile">
						...
						<ul id="user_menu" class="pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							...
							<li class="divider"></li>
							<li><a href="<?php echo base_url()."wp-admin/login/logout"?>"><i class="icon-off"></i>Thoát</a></li>
						</ul>
					</li>

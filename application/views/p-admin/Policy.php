...
<div class="row-fluid">
    <h3 class="header smaller lighter blue">Chính Sách
        <span style ="padding-left:80%"> </span>
    </h3>  
    <form id="contact" enctype="multipart/form-data" action="<?php echo base_url(); ?>wp-admin/policy/onUpdate" method="post">
		   	<?php echo $editor; ?> 
            <textarea id="desc" name="desc" style = "width: 638px; height: 180px;"><?php echo $policy; ?></textarea>

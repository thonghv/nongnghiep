...
<div class="row-fluid">
    <h3 class="header smaller lighter blue"><strong><?php echo $group_name; ?></strong>
    </h3> 
    <?php
    if(!isset( $_SESSION )) 
    { 
    ...
    <?php }?>
     ...
     <form method='post' onsubmit="return checkform()"  class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>wp-admin/category/add?group=<?php echo $group;?>" name="myForm">
        <div class="tabbable">
            ...
            <tr>
                <td>
                   ...
                   </style><strong>Chuyên đề&nbsp;</strong></label>
                </td>
    ...
    <table id="table_report" class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th style ="width: 70px;">Mã CD</th>
                    <th style ="width: 300px;">Tên Chuyên Đề</th>
                    <th></th>
                </tr>
            </thead>                   
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ul style = "padding-left: 10px; padding-top: 5px;">
                            <?php 
                                foreach ($menu_sub_detail_all as $val) {
                                    if($val -> sub_type == $row -> id) {
                            ?>
                                 <li style = "margin-bottom: 3px;"><?php echo $val -> detail_type_name; ?></li>
                            <?php } } ?>
                    ...
                    <div class="modal fade" id="confirm-delete-<?php echo $row -> id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Bạn có chắc chắn muốn xóa chuyên đề này ra khỏi danh sách hay không ?</p>
                                            <p class="debug-url"></p>
                                        </div>
                            ...
                            <a href="<?php echo base_url(); ?>wp-admin/category/detail?sub=<?php echo  $row -> id; ?>&group=<?php echo $group; ?>">
                            <input class='btn btn-mini btn-default' type="button" name="editsp" value="Danh Mục"/>
                             </a>

                            <a href="<?php echo base_url(); ?>wp-admin/category/onUpdate?group=<?php echo $group ?>&category=<?php echo  $row -> id ; ?>">

              ...
              <form class="form-horizontal">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name = "group_menu" onChange="getSubMenu(this.value)">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control" rows="3" id = "overivew" name = "overivew" placeholder="Giới thiệu tổng quan"></textarea>
                    </div>
                  </div>
                  <div class="form-group">

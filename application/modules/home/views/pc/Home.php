                                ...
                                <div class="header-grids">
                                    <div class="col-md-3 col-sm-6 col-xs-6 col-min-12 header-grid">
                                        <div class="header-img1 header-img wow fadeInUpBig animated animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUpBig;">
                                            <a href="<?php if(isset($topInfoImg[0])) { ?><?php echo base_url()?>san-pham/<?php echo $topInfo[0] -> slug; ?>-<?php echo $topInfo[0] ->id;?>.html<?php } ?>"><img src="<?php if(isset($topInfoImg[0])) { echo base_url(); ?>public/img-slide/<?php echo $topInfoImg[0] -> img_name; }?>" class="img-responsive" alt=""></a>
                                            <a href="<?php if(isset($topInfoImg[0])) { ?><?php echo base_url()?>san-pham/<?php echo $topInfo[0] -> slug; ?>-<?php echo $topInfo[0] ->id;?>.html<?php } ?>"><h4><?php if(isset($topInfo[0])) { echo $topInfo[0] -> name;} ?></h4></a>
                                            <p><?php if(isset($topInfo[0])) { echo $topInfo[0] -> overview;} ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-6 col-min-12 header-grid">
                                        <div class="header-img1 header-img wow fadeInUpBig animated animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUpBig;">
                                            <a href="<?php if(isset($topInfoImg[1])) { ?><?php echo base_url()?>san-pham/<?php echo $topInfo[1] -> slug; ?>-<?php echo $topInfo[1] ->id;?>.html<?php } ?>"><img src="<?php if(isset($topInfoImg[1])) { echo base_url(); ?>public/img-slide/<?php echo $topInfoImg[1] -> img_name; }?>" class="img-responsive" alt=""></a>
                                            <a href="<?php if(isset($topInfoImg[1])) { ?><?php echo base_url()?>san-pham/<?php echo $topInfo[1] -> slug; ?>-<?php echo $topInfo[1] ->id;?>.html<?php } ?>"><h4><?php if(isset($topInfo[1])) { echo $topInfo[1] -> name;} ?></h4></a>
                                            <p><?php if(isset($topInfo[1])) { echo $topInfo[1] -> overview;} ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-6 col-min-12 header-grid">
                                        <div class="header-img1 header-img wow fadeInUpBig animated animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUpBig;">
                                            <a href="<?php if(isset($topInfoImg[2])) { ?><?php echo base_url()?>san-pham/<?php echo $topInfo[2] -> slug; ?>-<?php echo $topInfo[2] ->id;?>.html<?php } ?>"><img src="<?php if(isset($topInfoImg[2])) { echo base_url(); ?>public/img-slide/<?php echo $topInfoImg[2] -> img_name; }?>" class="img-responsive" alt=""></a>
                                            <a href="<?php if(isset($topInfoImg[2])) { ?><?php echo base_url()?>san-pham/<?php echo $topInfo[2] -> slug; ?>-<?php echo $topInfo[2] ->id;?>.html<?php } ?>"><h4><?php if(isset($topInfo[2])) { echo $topInfo[2] -> name;} ?></h4></a>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-6 col-min-12 header-grid">
                                        <div class="header-img1 header-img wow bounceInRight animated animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: bounceInRight;">
                                            <a href="<?php if(isset($topInfoImg[3])) { ?><?php echo base_url()?>san-pham/<?php echo $topInfo[3] -> slug; ?>-<?php echo $topInfo[3] ->id;?>.html<?php } ?>"><img src="<?php if(isset($topInfoImg[3])) { echo base_url(); ?>public/img-slide/<?php echo $topInfoImg[3] -> img_name; }?>" class="img-responsive" alt=""></a>
                                            <a href="<?php if(isset($topInfoImg[3])) { ?><?php echo base_url()?>san-pham/<?php echo $topInfo[3] -> slug; ?>-<?php echo $topInfo[3] ->id;?>.html<?php } ?>"><h4><?php if(isset($topInfo[3])) { echo $topInfo[3] -> name;} ?></h4></a>

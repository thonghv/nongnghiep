...
<body>
    ...
    <div class="header bg_header" id="home" style = "margin-top: 55px;">
        <div class="slidercontainer">  
            <div class="showSlide">  
                <img height="600px" width="" src="<?php echo base_url()?>public/img/banner.jpg" />  
            </div>
            <div class="showSlide">  
                <img height="600px" src="http://files.vforum.vn/2015/T10/img/vforum.vn-233771-natural-landscape-16.jpg" />  
            </div>  
